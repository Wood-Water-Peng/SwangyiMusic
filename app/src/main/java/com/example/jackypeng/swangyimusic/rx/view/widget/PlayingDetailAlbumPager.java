...
public class PlayingDetailAlbumPager extends ViewPager {
    public PlayingDetailAlbumPager(Context context) {
        super(context);
    }

    public PlayingDetailAlbumPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
